...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_TAB,           KC_Q,          KC_W,          KC_E,         KC_R,            KC_T,           KC_COMMA_LBRACE,                                  KC_COMMA_LBRACE,       KC_Y,          KC_U,            KC_I,             KC_O,            KC_P,               KC_BSLASH,
    LT(1,KC_ESCAPE),  LCTL_T(KC_A),  LALT_T(KC_S),  LGUI_T(KC_D), LSFT_T(KC_F),    LCAG_T(KC_G),   KC_COMMA_LBRACE,                                  KC_LBRACKET_RBRACKET,  LCAG_T(KC_H),  LSFT_T(KC_J),    LGUI_T(KC_K),     LALT_T(KC_L),    LCTL_T(KC_SCOLON),  LT(2,KC_QUOTE),
    KC_COMMA_LBRACE,  KC_Z,          KC_X,          KC_C,         KC_V,            KC_B,           KC_COMMA_LBRACE,                                  KC_COMMA_LBRACE,       KC_N,          KC_M,            KC_COMMA_LBRACE,  KC_DOT_RBRACE,   KC_SLASH,           KC_LANGLEBR_RANGLEBR,
  ...
  [1] = LAYOUT(
    ...
    EEPROM_RESET,     KC_NO,         KC_MS_BTN2,    KC_MS_UP,     KC_MS_BTN1,      KC_MS_WH_DOWN,  KC_NO,                                            KC_NO,                 KC_MAC_CUT,    KC_MS_BTN1,      KC_NO,            KC_MS_BTN2,      KC_NO,              KC_NO,
    KC_NO,            KC_PGUP,       KC_MS_LEFT,    KC_MS_DOWN,   KC_MS_RIGHT,     KC_MS_WH_UP,    KC_NO,                                            KC_NO,                 KC_MAC_COPY,   KC_LSHIFT,       KC_LGUI,          KC_LALT,         KC_LCTRL,           KC_NO,
  ...
  [2] = LAYOUT(
    ...
    EEPROM_RESET,     KC_NO,         KC_NO,         KC_NO,        KC_NO,           KC_NO,          KC_NO,                                            KC_NO,                 KC_MAC_CUT,    LALT(KC_LEFT),   KC_UP,            LALT(KC_RIGHT),  KC_NO,              KC_NO,
